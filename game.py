...
class Game() :
    ...
    def switch_world(self) :
        ...
        self.music = pygame.mixer.Sound("world_music2.ogg")
        self.music.play(0, 0, 5000)
    ...
    def handle_input(self) :
        ...
        if pressed[pygame.K_z] and pressed[pygame.K_x] or pressed[pygame.K_UP] and pressed[pygame.K_x]: # si 'z' et 'x' sont appuyés :
        ...
        elif pressed[pygame.K_s] and pressed[pygame.K_x] or pressed[pygame.K_DOWN] and pressed[pygame.K_x]:
            self.player.speed_move_down()
            self.player.change_animation('down')
        elif pressed[pygame.K_q] and pressed[pygame.K_x] or pressed[pygame.K_LEFT] and pressed[pygame.K_x]:
            self.player.speed_move_left()
            self.player.change_animation('left')
        elif pressed[pygame.K_d] and pressed[pygame.K_x] or pressed[pygame.K_RIGHT] and pressed[pygame.K_x]:
